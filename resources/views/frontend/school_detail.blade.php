         ...
         <div class="section-content">
            <div class="row">
               <div class="col-md-12">
                  ...
                  <h2 class="title text-white">@t('مدرسة ')</h2>
               </div>
            </div>
         </div>
      </div>
            ...
            <div class="col-md-9 col-sm-9 col-xs-12">
               <div class="tab-content">
                                 ...
                                 <div class="col-md-10 col-sm-12 col-md-offset-1">
                                    ...
                                    <div class="col-sm-12 p-0">
                                       <div class="form-group mb-30">
                                          <label for="name">@t('الاسم')</label>
                                          <input id="name" name="name" class="form-control" type="text" placeholder="@t('خالد عبد العزيز')" required="" aria-required="true">
                                       </div>
                                    </div>
                                    <div class="col-sm-12 p-0">
                                       <div class="form-group mb-30">
                                          <label for="email">@t('البريد الألكتروني')</label>
                                          <input id="email" name="email" class="form-control" type="email" placeholder="ا@t('لبريد الألكتروني')" required="" aria-required="true">
                                       </div>
                                    </div>
                                    <div class="col-sm-12 p-0">
                                       <div class="form-group mb-30">
                                          <label for="password">@t(' الرقم السري')</label>
                                          <input id="password" name="password" class="form-control" type="password" placeholder="@t(' الرقم السري')" required="" aria-required="true">
                                       </div>
                                    </div>
                                    <div class="col-sm-12 p-0">
                                       <div class="form-group mb-30">
                                    ...
                                    <div class="col-sm-12 p-0">
                                       <div class="form-group mb-30">
                                          ...
                                          <select class="form-control" id="gender">
                                             <option>@t('ذكر')</option>
                                             <option>@t('أنثي')</option>
                                          </select>
                                       </div>
                                    </div>
                                    <div class="col-sm-12 p-0">
                                       <div class="form-group mb-30">
                                          <label for="age">@t('العمر')</label>
                                          <input id="age" name="age" class="form-control" type="text" placeholder="@t('العمر')" required="" aria-required="true">
                                       </div>
                                    </div>
                                    <div class="col-sm-12 p-0">
                                       <div class="form-group mb-30">
                                          <label for="field">@t('التخصص')</label>
                                          <input id="field" name="field" class="form-control" type="text" placeholder="@t('التخصص')" required="" aria-required="true">
                                       </div>
                                    </div>
                  ...
                  <div class="tab-pane fade" id="tab2">
                     <div class="row mb-30">
                        <div class="col-md-12">   
                           <a href="products.html" class="btn btn-dark btn-xl btn-blue pull-left"><i class="fa fa-plus ml-10"></i>
                            @t(' إستعراض المنتجات ')
                           </a>
                        </div>
                     </div>
                              ...
                              <table class="table  sub-table">
                                 ...
                                 <tbody>
                                    <tr>
                                       ...
                                       <td class="color-theme-green">@t('اسم الاشتراك ')</td>
                                       <td class="color-dark-green">85</td>
                                       <td>
                                          <a href="packages.html" class="btn btn-default btn-lg blue">@t('عرض التفاصيل')</a>
                                       </td>
                                    </tr>
                                    <tr>
                                       <td class="half-gray">22/1/2019</td>
                  ...
                  <div class="tab-pane fade in active" id="tab4">
                     <div class="row mb-30">
                        <h4 class="color-theme-green mt-0 mb-30 font-weight-600 font-18">@t('تفاصيل المدرسة')</h4>
                        <div class="col-md-12">
                           <div class="table-responsive table-condensed">
                              <table class="table sub-table">
                                 <tbody>
                                    <tr>
                                       <td class="color-dark-green">@t('اسم المدرسة')</td>
                                       <td class="half-gray">{{ $schoolNative->name }} </td>
                                    </tr>
                                    <tr>
                                       <td class="color-dark-green">@t('وصف المدرسة:  ')</td>
                     ...
                     <div class="row">
                        <h4 class="color-theme-green mt-0 mb-30 font-weight-600 font-18">@t('الدورات')</h4>
                        <?php if (count($courseNative) > 0): ?>
                        <?php foreach ($courseNative as $key => $courses): ?>
                        <div class="col-md-12 course-container">
                           <article class="post media-post clearfix pb-0 mb-10">
                              <img src="\public\storage\{{ $courses->image }}" class="pull-right ml-20" alt="{{ $schoolNative->name }}">
                              ...
                              <table class="table  sub-table">
                                 <thead>
                                    <tr>
                                       <th>@t('رقم الدرس')</th>
                                       <th>@t('عنوان الدرس')</th>
                                       <th>@t('عدد ساعات الدرس')</th>
                                       <th>@t('الحالة ')</th>
                                       <th>@t('حالة الاختبار')</th>
                                       <th></th>
                                    </tr>
                                 </thead>
                                 <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td class="color-dark-green"><?php 
                                          ...
                                          <?php else: ?>
                                          <span class="text-dark">@t('Not taken')</span>
                                          <?php endif ?>
                                       </td>
                                       <?php if ($key == 0): ?>
                                       ...
                                       <?php if ($userPassed): ?>
                                       <td>
                                          <a href="{{ lang_url('chapters/'.$chapter->chapters->id.'/view') }}" class="btn btn-default btn-lg blue">@t('عرض التفاصيل')</a>
                                       </td>
                                       <?php else: ?>
                        ...
                        <div class="col-md-12 course-container">
                           <article class="post media-post clearfix pb-0 mb-10">
                              <div class="post-right">
                                 <h4 class="post-title mt-0 color-dark-green"> @t(' No Courses Found!')</h4>
                              </div>
                           </article>
                        </div>
                        <?php endif ?>
                  ...
                  <div class="tab-pane fade" id="tab5">
                     <div class="row mb-30">
                        <div class="col-md-12">   
                           <a href="online-schools.html" class="btn btn-dark btn-xl btn-blue pull-left"><i class="fa fa-plus ml-10"></i>@t('إستعراض الأنشطة ')</a>
                        </div>
                     </div>
                     <div class="row">
                        <div class="col-md-12">
