            ...
            <div class="container">
              <nav id="menuzord-right" class="menuzord orange">
                ...
                <ul class="menuzord-menu dark">
                  <li class="active"><a href="{{ lang_url('') }}">الرئيسية </a></li>
                  <li class="">
                  ...
                  <li class="">
                    <a href="{{ lang_url('plans_pricing') }}">الخدمات </a>
                    <ul class="dropdown">
        ...
        <div class="container pt-70 pb-40">
          <div class="row">
            ...
            <div class="col-sm-6 col-md-4 col-xs-12 footer-widget-col">
              <div class="widget dark">
                <h4 class="widget-title">صفحات الموقع</h4>
                <div class="col-md-6 col-sm-12 p-0">
                  <ul class="list angle-double-right list-border">
                    <li><a href="{{ lang_url('about') }}"><span>-</span> عن الاتجاه الأفضل </a></li>
                    <li><a href="{{ lang_url('') }}"><span>-</span> بوابة المستخدمين</a></li>
                    <!-- <li><a href="news.html"><span>-</span> الاخبار والمقالات </a></li> -->
                    <!-- <li><a href="calendar.html"><span>-</span> تقويم الأحداث </a></li> -->
                    <li><a href="{{ lang_url('coaches') }}"><span>-</span> المدربين </a></li>
                  </ul>
                </div>
                <div class="col-md-6 col-sm-12 p-0">
                  <ul class="list angle-double-right list-border">
                    <li><a href="{{ lang_url('our_partners') }}"><span>-</span> الشركاء</a></li>
                    <li><a href="{{ lang_url('terms_and_conditions') }}"><span>-</span> ساسية وشروط الاستخدام </a></li>
                    <!-- <li><a href="warning.html"><span>-</span> إشعار التحذير من المخاطر   </a></li> -->
                    <li><a href="{{ lang_url('contact_us') }}"><span>-</span> التواصل </a></li>
                  </ul>
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-md-3 col-xs-12 footer-widget-col">
              <div class="widget dark">
                <h4 class="widget-title">المنتجات والخدمات </h4>
                <ul class="list angle-double-right list-border">
                  <li><a href="{{ lang_url('books') }}"><span>-</span> الكتب</a></li>
                  <!-- <li><a href="general-file.html"><span>-</span> الملف الشامل </a></li>     -->
                  <li><a href="{{ lang_url('allschools') }}"><span>-</span> المدرسة الالكترونية  </a></li>
                  <li><a href="{{ lang_url('plans_pricing') }}"><span>-</span> باقات الاشتراك   </a></li>
                  <li><a href="{{ lang_url('events') }}"><span>-</span> الدورات  </a></li>
                </ul>
              </div>
            </div>
            <div class="col-sm-6 col-md-3 col-xs-12 footer-widget-col">
              <div class="widget dark">
                ...
                <h4 class="widget-title">القائمة</h4>
                ...
                <form id="mailchimp-subscription-form-footer" class="newsletter-form" action="{{ lang_url('email_subscribe_user') }}" method="POST">
                  ...
                  <div class="input-group">
                    <input type="email"  name="email" placeholder="Your Email" class="form-control input-lg font-16" data-height="45px" id="mce-EMAIL-footer" required>
                    <span class="input-group-btn">
                    <button data-height="45px" class="btn bg-theme-color-2 text-white btn-xs m-0 font-14" type="submit">إشتراك</button>
                    </span>
                  </div>
                </form>
              </div>
          ...
          <div class="row">
            <div class="col-sm-12 col-md-12 col-xs-12">
              <div class="widget dark">
                <h4 class="widget-title" style="color:#D5D5D5 !important">أشعار المخاطر </h4>
                <p class="">أن نكون الخيار الأول في  معرفة التداولأن نكون الخيار الأول في  معرفة التداولأن نكون الخيار الأول في  معرفة التداولأن نكون الخيار الأول في  معرفة التداولأن نكون الخيار الأول في  معرفة التداولأن نكون الخيار الأول في  معرفة التداولأن نكون الخيار الأول في  معرفة التداولأن نكون الخيار الأول في  معرفة التداولأن نكون الخيار الأول في  معرفة التداولأن نكون الخيار الأول في  معرفة التداولأن نكون الخيار الأول في  معرفة التداولأن نكون الخيار الأول في  معرفة التداولأن نكون الخيار الأول في  معرفة التداولأن نكون الخيار الأول في  معرفة التداولأن نكون الخيار الأول في  معرفة التداولأن نكون الخيار الأول في  معرفة التداولأن نكون الخيار الأول في  معرفة التداولأن نكون الخيار الأول في  معرفة التداولأن نكون الخيار الأول في  معرفة التداولأن نكون الخيار الأول في  معرفة التداولأن نكون الخيار الأول في  معرفة التداولأن نكون الخيار الأول في  معرفة التداولأن نكون الخيار الأول في  معرفة التداولأن نكون الخيار الأول في  معرفة التداول</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="container pt-15 pb-10">
            <div class="row">
              ...
              <div class="col-md-6 text-left">
                <p class="font-14 color-gray-light m-0">All copyrights reserved © 2018- 2015 </p>
              </div>
            </div>
          </div>
        </div>
