   ...
   <div class="row">
      <div class="col-10 order-md-1">
         ...
         <div class="row">
            <div class="col-12 col-md-12 col-sm-6 col-xs-12 mb-3">
               ...
               <select name="payment_type" class="form-control payment_type" id="payment_type" required>
                  <option value="" hidden>@t('Payment way')</option>
                  <option value="online">@t('Online(Visa, Mastercard etc)')</option>
                  <option value="offsite">@t('Offsite(Wire transfer, Cash, Waiver, Scholarship etc)')</option>
               </select>
               <?php endif ?>
            </div>
         </div>
         ...
         <div class="row payment_options_dv hide">
            <div class="col-12 col-md-12 col-sm-6 col-xs-12 mb-3">
               ...
               <select name="payment_options" class="form-control payment_options" id="payment_options">
                  <option value="" hidden>@t('Payment Options')</option>
                  <?php if ($eventNative->events->payment_option == 1): ?>
                  <option value="one_payment">@t('One Payment')</option>
                  <?php elseif ($eventNative->events->payment_option == 2): ?>
                  <option value="multiple_payment">@t('Multiple Payment')</option>
         ...
         <div class="row instal_dv {{ $subscription->payment_status == 'Partially Paid' ? NULL : 'hide' }}">
            <div class="col-12 col-md-12 col-sm-6 col-xs-12">
               <h5>@t('Instalments:') <b><span><?php echo (int)$eventNative->events->instalments; ?></span></b></h5>
               <h5>@t('Amount:') 
               ...
               <?php if ($subscription->payment_status == 'Partially Paid'): ?>
               <span>@t('Remaining:') <b><?php echo ((int)$eventNative->events->instalments - (int)$subscription->instalment_no); ?></b></span>
               <?php endif ?>
                     ...
                     <div class="row">
                        ...
                        <div class="row">
                           <div class="col-7 col-md-7 col-lg-7">
                              <div class="form-group">
                                 <label for="cardExpiry"><span class="hidden-xs">@t('EXPIRATION')</span><span class="visible-xs-inline">@t('EXP')</span>@t('DATE') </label>
                                 <input
