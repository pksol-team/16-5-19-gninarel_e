            ...
            <div class="row rtl">
               <div class="col-md-8 col-md-offset-2 col-xs-12 col-sm-12">
                  <div class="col-xs-12 col-sm-6 col-md-6 hvr-float-shadow mb-sm-30">
                     ...
                     <a data-toggle="modal" data-target="#pay-modal" class="btn btn-lg btn-theme-green text-uppercase btn-block pt-20 pb-20 btn-flat">@t('شراء الملف باستخدام الدفع الالكتروني')</a>
                  </div>
                  <div class="col-xs-12 col-sm-6 col-md-6 hvr-float-shadow mb-sm-30">
                     <div class="pricing-table maxwidth400">
                     </div>
                     ...
                     <a data-toggle="modal" data-target="#pay-modal" class="btn btn-lg btn-theme-green text-uppercase btn-block pt-20 pb-20 btn-flat">@t('شراء الملف باستخدام التحويل البنكي')</a>
                  </div>
               </div>
            </div>
         </div>
   ...
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         <div class="modal-header">
            ...
            <p class="text-gray mb-0 text-right">@t('رقم الايبان :') <span>@t(' sasasasasasasas')</span></p>
         </div>
                  ...
                  <div class="col-md-12 col-sm-12">
                     <div class="col-sm-12 p-0">
                        <div class="form-group mb-30">
                           ...
                           <input id="first_name" name="first_name" class="form-control" type="text" placeholder="@t('الاسم الاول')" required="" value="{{ Auth::check() ? Auth::user()-> name : '' }}" aria-required="true">
                        </div>
                     </div>
                     <div class="col-sm-12 p-0">
                        <div class="form-group mb-30">
                           <label for="last_name">@t('الكنية')</label>
                           <input id="last_name" name="last_name" class="form-control" type="text" placeholder="@t('الكنية')" required="" aria-required="true" value="{{ Auth::check() ? Auth::user()->last_name : '' }}">
                        </div>
                     </div>
                     <div class="col-sm-12 p-0">
                        <div class="form-group mb-30">
                           <label for="user_address">@t('عنوان')</label>
                           <input id="user_address" name="user_address" class="form-control" type="text" placeholder="@t('عنوان')" required="" aria-required="true" value="{{ Auth::check() ? Auth::user()->location : '' }}">
                        </div>
                     </div>
                     ...
                     <div class="col-sm-12 p-0">
                        <div class="form-group mb-30">
                           <label for="account_number">@t('الحساب ')</label>
                           <input id="account_number" name="account_number" class="form-control" type="text" placeholder="@t('رقم الحساب')" required="" aria-required="true">
                        </div>
                     </div>
                     <div class="col-sm-12 p-0">
                        <div class="form-group mb-30">
                     ...
                     <div class="col-sm-12 list-group-item d-flex justify-content-between ">
                        <h6 class="my-0">@t('السعر الكلي')</h6>
