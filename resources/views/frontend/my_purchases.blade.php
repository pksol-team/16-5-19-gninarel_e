            ...
            <div class="col-md-3 col-sm-3 col-xs-12">
               <div class="vertical-tab">
                  <ul class="nav nav-tabs">
                     ...
                     <li class="active"><a class="d-block" href="#tab2" ><img src="/frontend/_assets/images/icon-2.png" class="img-responsive" alt="icon-2"/>@t('My purchases') </a></li>
            ...
            <div class="col-md-9 col-sm-9 col-xs-12">
               <div class="tab-content">
                  <div class="tab-pane fade in active " id="tab2">
                     <div class="row mb-30">
                        <div class="col-md-12">
                           <a href="{{ lang_url('listings') }}" class="btn btn-dark btn-xl btn-blue pull-left"><i class="fa fa-plus ml-10"></i>@t('Product Review ')</a> 
                        </div>
                     </div>
                     <div class="row">
                        <div class="col-md-12">
                                 ...
                                 <tbody>
                                    @if($all_purchases)
                                       ...
                                       <tr>
                                          ...
                                          <td>
                                             <a href="#" class="btn btn-default btn-lg blue">@t('View details')</a>
                                          </td>
                                       </tr>
                                       @endforeach
                                    @else
