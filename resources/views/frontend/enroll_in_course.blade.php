      ...
      <div class="col-10 order-md-1">
        <div class="row">
          <div class="col-12 mb-3">
            <label for="first_name">Course Price: <b>{{ $courseNative->courses->price }}</b></label>
          </div>
        </div>
        <?php if (!Auth::check()): ?>
        ...
        <div class="row">
          <div class="col-12 mb-3">
            ...
            <input type="text" class="form-control" value="{{ old('first_name') }}" id="first_name" name="first_name" placeholder="First name" required>
          </div>
        </div>
        <div class="row">
          <div class="col-12 mb-3">
            <label for="last_name">Last name</label>
            <input type="text" class="form-control" value="{{ old('last_name') }}" id="last_name" name="last_name" placeholder="Last name" required>
          </div>
        </div>
        <div class="row">
          <div class="col-12 mb-3">
            <label for="mobile_number">Mobile Number</label>
            <input type="text" class="form-control" value="{{ old('mobile_number') }}" id="mobile_number" name="mobile_number" placeholder="+123-342" required>
          </div>
        </div>
        <div class="row">
          <div class="col-12 mb-3">
