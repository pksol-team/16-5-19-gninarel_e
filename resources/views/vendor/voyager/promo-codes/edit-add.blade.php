        ...
        $('document').ready(function () {
           ...
           // dropdownSelect($objectType, $initObject);
            ...
            function dropdownSelect($objectType, $initObject) {
                $.ajax({
                    type: 'POST',
                    url: '{{ lang_url("dropdownFieldSelect") }}',
                    data: {"_token": "{{ csrf_token() }}", 'objectType':$objectType},
                })
            ...
            $('select[name=object_type]').on('change', function(e) {
                e.preventDefault();
                $initObject = $objectType = this.value;
