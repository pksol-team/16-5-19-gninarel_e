                            ...
                            @elseif($row->type == 'select_dropdown' && property_exists($row->details, 'options') &&
                                ...
                                @elseif(($row->type == 'select_dropdown' || $row->type == 'radio_btn') && property_exists($row->details, 'options'))
                                    ...
                                    @elseif($row->field == 'object_id')
                                        @if(json_decode($dataTypeContent)->object_type == '1')
                                            @php
                                                $product = ProductsNative::find(json_decode($dataTypeContent)->object_id);
                                                echo($product->name);
                                            @endphp
                                        ...
                                        @else
                                            @php
                                                $event = Event::find(json_decode($dataTypeContent)->object_id);
                                                echo($event->name);
                                            @endphp
                                        @endif
                                    @endif
