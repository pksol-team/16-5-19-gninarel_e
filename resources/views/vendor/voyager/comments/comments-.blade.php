                                ...
                                <thead>
                                    <tr role="row">
                                       <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="
                                          Comment
                                          : activate to sort column ascending" style="width: 89px;">
                                          Comment
                                       </th>
                                       <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="
                                          Status
                                       ...
                                       <th class="actions text-right sorting_disabled" rowspan="1" colspan="1" aria-label="Actions" style="width: 370px;">Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td><?php $user = User::find($data->user_id); echo $user->name ?></td>
                                        <td class="no-sort no-click" id="bread-actions">
                                            @foreach(Voyager::actions() as $action)
                                                ...
                                                @endif
                                            @endforeach
                                            <a style="margin-right: 5px;" href="{{ lang_url($data->id.'/comments_reply') }}" title="View" class="btn btn-sm btn-success pull-right view">
