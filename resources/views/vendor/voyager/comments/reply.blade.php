...
@section('page_title', 'Reply Comment')
                    ...
                    <form role="form"
                        ...
                        <div class="panel-body">
                           ...
                           <div class="form-group   col-md-12 ">
                              ...
                              <input type="hidden" class="form-control" name="video_id" value="{{ $comment->video_id }}">
                              <input type="hidden" class="form-control" name="parent_id" value="{{ $comment->id }}">
                              <input type="hidden" class="form-control" name="user_id" value="{{ Auth::user()->id }}">
                              <input type="hidden" class="form-control" name="coach_id" value="{{ Auth::user()->id }}">
