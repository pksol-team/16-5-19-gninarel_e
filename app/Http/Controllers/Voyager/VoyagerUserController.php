...
class VoyagerUserController extends \TCG\Voyager\Http\Controllers\VoyagerBaseController
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $user = Auth::user();
        if ($userData->role_id != '2' && $request->role_id == '2') {

            $subject = 'Better Trend Coach Request';

            $msg_templateUser = '
            <div style="text-align: left;padding-left: 20px;padding-top: 50px;padding-bottom: 30px;">
                <h3>Congratulations: </h3>
                <h4 style="padding: 0 20px 0 0;">Hello '.$request->name.' <br><br>
                </h4>
                <br>
                <p>Thank you for your interest! You request of coach has been approved</p>
                <p>Now you can login on admin panel as well</p>
            </div>';
            
            $data = array( 'email' => $request->email, 'subject' => $subject, 'message' => $msg_templateUser);
