...
class VoyagerCommentsController extends \TCG\Voyager\Http\Controllers\VoyagerBaseController
{
    ...
    public function comments_reply_backend($comment_id, Request $request)
    {
        ...
        $view = 'voyager::bread.comments';

        if (view()->exists("voyager::$slug.comments")) {
            $view = "voyager::$slug.comments";
        }
    ...
    public function reply($comment_id)
    {
        ...
        $view = 'voyager::bread.reply';

        if (view()->exists("voyager::$slug.reply")) {
            $view = "voyager::$slug.reply";
        }

        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'comment'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect(lang_url('admin/'.$data->parent_id.'/comments_reply'))
        ->with([
